"use strict";
// ════════════════════════════════════════════════════════════════════════════
// GHOST WICK PROTOCOL — ALTCOIN EDITION  v8.0  MONEY PRINTING MACHINE ELITE MAX™
...
const V = "GWP Altcoin v8.0 | Elite Max™ | 24/7 | Asterix.COM | Abdin";
...
async function sendHealth(){
  let msg=`💚 <b>GWP Altcoin v8.0 ELITE MAX — HEALTH</b>\n\n`;
...
async function sendStatus(){
  ...
  await tgSend(
    `📡 <b>GWP Altcoin v8.0 ELITE MAX — ONLINE</b> ✅\n\n`+
...
async function sendHelp(){
  await tgSend(
    `👻 <b>GWP ALTCOIN v8.0 ELITE MAX™</b>\n`+
...
async function runBot(){
  console.log(`\n═══ GWP ALTCOIN v8.0 ELITE MAX ═══ ${new Date().toISOString()}`);
...
(async()=>{
  ...
  console.log(`GWP Altcoin v8.0 ELITE MAX | mode: ${mode} | ${new Date().toISOString()}`);
