...
module.exports = {
  ...
  SYMBOLS: [
    ...
    // v1.1.9 (frequency) — 3 additional liquid tickers. Kept modest: this
    // bot already runs closest to Twelve Data's credit budget AND to the
    // equities intraday-history depth ceiling (see config.js's v1.1.5
    // note above) of any of the three bots — watch scan logs for "daily
